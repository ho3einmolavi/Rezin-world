<template>
    <div class="all">
        ...
        <h1 class="errorcode">خطای 403</h1>
        <div class="errortext">اینجا منطقه ممنوعه است. همین الان برگرد</div>
    </div>
...
<style scoped>
    .all {
        ...
        font-family: 'Roboto', sans-serif , irs;
    ...
    .errorcode {
        ...
        position: relative;
        top: -200px;
        font-family: 'Creepster', cursive , irs;
        color: white;
        text-align: center;
        font-size: 6em;
